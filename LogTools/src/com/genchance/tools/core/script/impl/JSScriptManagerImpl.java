package com.genchance.tools.core.script.impl;
...
import com.genchance.tools.core.ai.AIException;
...
public class JSScriptManagerImpl implements IScriptEngine {
	...
	public Object runScript(Map<String, Object> binding, String scriptFile, String charset) {
		...
		try {
			...
			throw new RuntimeException(ErrorsUtil.error(CoreErrors.FILE_IO_FAIL, "Throw Exception",
					scriptFile), e);
		} catch (ScriptException se) {
			throw new RuntimeException(ErrorsUtil.error(CoreErrors.SCRITP_EXECUTE_FAIL,
